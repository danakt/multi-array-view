...
declare class MultiArrayView<T> {
     ...
     */
    static create<T>(shape: number[], Constructor?: ArrayLikeConstructor<T>, offset?: number): MultiArrayView<T>;
    /**
     ...
     * @param [offset=0] The offset to start the view
     */
    static wrap<T>(array: ArrayLike<T>, shape: number[], offset?: number): MultiArrayView<T>;
    /**
     * The source array
     */
    array: ArrayLike<T>;
     ...
     * @param [offset=0] The offset to start the view
     */
    constructor(array: ArrayLike<T>, shape: number[], offset?: number);
}
